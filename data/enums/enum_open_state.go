...
type OpenStateCondType int

const (
	OPEN_STATE_NONE OpenStateCondType = iota
...
func (s OpenStateCondType) String() string {
	return OpenStateCondTypeToString[s]
}

var OpenStateCondTypeToString = map[OpenStateCondType]string{
	OPEN_STATE_NONE:                  "OPEN_STATE_NONE",
	OPEN_STATE_COND_PLAYER_LEVEL:     "OPEN_STATE_COND_PLAYER_LEVEL",
	OPEN_STATE_COND_QUEST:            "OPEN_STATE_COND_QUEST",
	OPEN_STATE_OFFERING_LEVEL:        "OPEN_STATE_OFFERING_LEVEL",
	OPEN_STATE_CITY_REPUTATION_LEVEL: "OPEN_STATE_CITY_REPUTATION_LEVEL",
	OPEN_STATE_COND_PARENT_QUEST:     "OPEN_STATE_COND_PARENT_QUEST",
}

var OpenStateCondTypeToID = map[string]OpenStateCondType{
	"OPEN_STATE_NONE":                  OPEN_STATE_NONE,
	"OPEN_STATE_COND_PLAYER_LEVEL":     OPEN_STATE_COND_PLAYER_LEVEL,
	"OPEN_STATE_COND_QUEST":            OPEN_STATE_COND_QUEST,
	"OPEN_STATE_OFFERING_LEVEL":        OPEN_STATE_OFFERING_LEVEL,
...
func (s OpenStateCondType) MarshalJSON() ([]byte, error) {
	buffer := bytes.NewBufferString(`"`)
	buffer.WriteString(OpenStateCondTypeToString[s])
	buffer.WriteString(`"`)
	return buffer.Bytes(), nil
}

func (s *OpenStateCondType) UnmarshalJSON(b []byte) error {
	var j string
